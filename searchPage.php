                                ...
                                <nav aria-label="Page navigation example" class="d-flex justify-content-end">
                                    <ul class="pagination">
                                        ...
                                        <?php for ($i = $start; $i <= $end; $i++) { ?>
                                            <li class="page-item">
                                                <a class="page-link" href="javascript:void(0)" onclick="loadPage(<?php echo $i ?>,'<?php echo $search ?>')">
                                                    <?php echo $i; ?>
                                                </a>
                                            </li>
                                        <?php
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="javascript:void(0)" onclick="loadPage(<?php echo ($page + 1) ?>,'<?php echo $search ?>')">
